...
def display_trajectory(trj):               
    ...
    plt.plot(trj[0,0], trj[0,1], 'yo', label='Initial')  # plot initial position as yellow circle
    plt.plot(trj[-1,0], trj[-1,1], 'rx', label='Final')  # plot final position as red cross
    plt.plot(trj[:,0], trj[:,1], 'b') # plot trajectory in blue
    ax.legend()
